...
export type InvestmentTransaction = RouterOutputs['investments']['transactions']['byItem'][string][number]
export type InvestmentTransactionItemError = RouterOutputs['investments']['transactions']['itemErrors'][number]
