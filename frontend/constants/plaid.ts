...
//
// This array is a mechanical derivation of backend/src/lib/plaid/pfc.ts `DEFAULT_PFC_MAPPING`
// ({ primary, detailedCodes } per entry, in the same order). Regenerate it whenever that
// backend file changes — drift here means picker codes silently fail to match transactions.
